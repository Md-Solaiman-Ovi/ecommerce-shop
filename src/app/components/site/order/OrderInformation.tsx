...
const OrderInformation = () => {
  return (
    <div className="lg:w-3/4 bg-white p-10 rounded flex flex-col gap-12 ">
      <div className="font-bold text-xl text-center">Order information</div>
      <div className="flex flex-col xl:flex-row items-baseline gap-4 xl:gap-48">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-white border-b-[1px]">
            <div className="flex justify-between items-center px-5 py-4 text-center text-sm md:text-base">
      ...
      <div className="flex justify-end items-center">
        <Link
          href="/my-orders"
          className="w-full xl:w-1/4 text-sm bg-[rgba(24,41,59,1)] text-white text-center py-2 rounded cursor-pointer"
        >
          Go Back Home
        </Link>
      </div>
