...
const FQA = () => {
  ...
  return (
    <PageLayout title="Frequently Asked Questions (FAQ)" className="py-10  ">
      <div className="leading-[30px] font-normal py-10 ">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet cursus
        nunc sed habitant diam pellentesque sed non eget. Vel sapien, phasellus
        non quam maecenas tellus. Egestas mauris, vitae, mattis sed. Mattis
        aliquet venenatis lectus a, eu leo sit. Lorem ipsum dolor sit amet,
        consectetur adipiscing elit. Amet cursus nunc sed habitant diam
      ...
      <div className="flex flex-col  gap-4">
        <div className="question border-1 border-solid border-slate-300 rounded">
          ...
          {isOpen1 && (
            <div
              className={`leading-[30px] font-normal  py-4  transition  -translate-x-50 ${
                isOpen1 ? "   duration-1000 delay-300 " : ""
              } `}
            >
              ...
              facilisis posuere dui turpis ut vitae purus. Lorem ipsum dolor sit
              amet consectetur.
            </div>
          )}
        </div>
        ...
        <div className="question border-1 border-solid border-slate-300 rounded">
          <div className="flex justify-between items-center py-4 border-b-[1px]">
            <div className=" font-normal text-black">
              Can I see the companies whose requirements match with mine though
